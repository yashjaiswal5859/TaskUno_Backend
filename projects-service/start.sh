...
echo "🚀 Starting Projects Service (Port 8004)..."
echo ""
...
# Start the server
echo ""
echo "✅ Starting Projects Service on http://localhost:8004"
...
python3 -m uvicorn src.main:app --reload --host 0.0.0.0 --port 8004
