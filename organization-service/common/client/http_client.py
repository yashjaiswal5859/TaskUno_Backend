...
Used across all microservices for consistent service-to-service calls.
"""
import httpx
...
# Convenience function to create service clients
def create_service_client(service_url: str, timeout: int = 30) -> ServiceClient:
    """Create a service client instance."""
    return ServiceClient(service_url, timeout)
