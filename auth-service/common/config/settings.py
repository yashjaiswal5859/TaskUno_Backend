...
Used across all microservices for consistent configuration.
"""
...
class Settings(BaseSettings):
    ...
    ORGANIZATION_SERVICE_URL: str = "http://localhost:8002"
    TASKS_SERVICE_URL: str = "http://localhost:8003"
    PROJECTS_SERVICE_URL: str = "http://localhost:8004"
    ...
    REDIS_PORT: int = 6379
    REDIS_DB: int = 0
    REDIS_SOCKET_CONNECT_TIMEOUT: int = 1
